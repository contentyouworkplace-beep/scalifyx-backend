/**
 * Scalify Knowledge Base — 500 Q&A pairs for AI sales assistant
...
const KNOWLEDGE_BASE = {
  ...
  pricing: [
    { q: "How much does Scalify cost?", a: "Scalify Pro is just ₹1,499/month — that's 63% OFF the regular price of ₹2,499/month! You get a professional website + full SEO, which normally costs ₹15,000-50,000 separately." },
    { q: "Is there a free plan?", a: "We don't offer a free plan because we provide real, hands-on SEO work and a custom-built website — that requires dedicated effort. But at ₹1,499/month, it's less than ₹25/day for a full online presence!" },
    { q: "Why should I pay ₹1,499/month?", a: "Think about it — a single newspaper ad costs ₹2,000-5,000 and runs ONE day. Scalify gives you a website + SEO that works 24/7 for just ₹1,499/month. Your website brings customers while you sleep!" },
    ...
    { q: "Is there a yearly plan?", a: "Currently we offer monthly billing at ₹1,499/month. This gives you flexibility to see results before committing long-term. Annual plans are coming soon with even bigger discounts!" },
    ...
    { q: "Why is there a discount right now?", a: "We're in our early growth phase and offering 63% OFF (₹1,499 instead of ₹2,499) to our first customers. This price won't last forever — lock it in now!" },
    ...
    { q: "Is ₹1,499 a one-time payment?", a: "₹1,499 is a monthly subscription that includes your website hosting, maintenance, SSL, AND ongoing SEO optimization. It's everything-included pricing." },
    { q: "Do I need to pay extra for SEO?", a: "Nope! SEO is fully included in your ₹1,499/month plan. On-page SEO, technical SEO, Google Search Console setup, keyword optimization — all included." },
    ...
    { q: "Can I upgrade my plan later?", a: "Right now we have one all-inclusive Pro plan at ₹1,499/month. We're working on premium tiers with e-commerce features coming soon!" },
    ...
    { q: "Do I need to pay for domain separately?", a: "You get a free subdomain (yourbusiness.scalifyapp.com). If you want a custom domain like yourbusiness.com, you can connect it — domain registration is separate (₹500-800/year from any registrar)." },
    { q: "How does ₹1,499 compare to hiring a developer?", a: "A freelance developer charges ₹15,000-50,000 just for the website. SEO agencies charge ₹5,000-15,000/month. With Scalify, you get BOTH for just ₹1,499/month!" },
    { q: "Will the price increase later?", a: "If you subscribe now at ₹1,499/month, you're locked into this rate. Even if we raise prices for new customers, your rate stays the same." },
    { q: "Is there any setup fee?", a: "No setup fee, no hidden charges. ₹1,499/month is all you pay. Website creation, hosting, SSL, maintenance, SEO — everything is included." },
    ...
    { q: "Is it worth it for a small business?", a: "Especially for small businesses! You'd otherwise spend ₹30,000+ on a website and ₹10,000/month on SEO. Scalify gives you both for just ₹1,499/month." },
    { q: "Do you have EMI options?", a: "At ₹1,499/month, it's already very affordable. But yes, if you pay via credit card through Razorpay, your bank may offer EMI options." },
    ...
    { q: "Is this cheaper than Wix or WordPress?", a: "Yes! Wix Premium is ₹250-700/month but has NO SEO service included. WordPress hosting is ₹300-500/month plus you need to build it yourself. Scalify = website + SEO + support for ₹1,499." },
    { q: "Why not use a free website builder?", a: "Free builders give you ugly templates, show their branding, have no SEO, and look unprofessional. Scalify gives you a custom, professional website with real SEO that ranks on Google." },
    { q: "How much do I save with Scalify?", a: "Without Scalify: Website (₹25,000 one-time) + Hosting (₹6,000/year) + SEO (₹10,000/month) = ₹1,31,000/year. With Scalify: ₹1,499 × 12 = ₹8,988/year. You save over ₹1,20,000!" },
    { q: "Is GST extra?", a: "The ₹1,499/month price is the final amount you pay. No hidden charges." },
    ...
    { q: "Can I get a custom quote?", a: "Our standard Pro plan at ₹1,499/month fits most businesses. For enterprise needs, reach out to our support team." },
    { q: "Is there a student discount?", a: "We don't have a student discount currently, but at ₹1,499/month it's already the most affordable professional website + SEO solution in India!" },
    ...
    { q: "What's included in ₹1,499?", a: "Everything: Professional website, unlimited pages, free hosting, SSL certificate, website maintenance, on-page SEO, technical SEO, Google Search Console, mobile responsive design, WhatsApp button, contact forms, social media integration, monthly analytics reports, and priority support!" },
    { q: "Is this a scam?", a: "Absolutely not! Scalify is a registered company. We use Razorpay (India's leading payment gateway), provide GST invoices, and have thousands of happy customers. Check our reviews!" },
  ],
  ...
  features: [
    ...
    { q: "Will my website work on mobile?", a: "Yes! Every Scalify website is fully mobile responsive. It looks perfect on phones, tablets, and desktops. Over 80% of your visitors will come from mobile!" },
    ...
    { q: "Will my website be fast?", a: "Yes! Scalify websites are optimized for speed. Fast hosting + optimized code + compressed images = lightning-fast load times." },
    ...
    { q: "Is the website design unique?", a: "Every website is customized with your content, photos, and branding. No two Scalify websites look the same!" },
  ...
  seo: [
    ...
    { q: "Is my website already SEO-optimized?", a: "Every Scalify website is built with SEO best practices from day one — clean code, proper structure, fast loading, mobile-friendly, and semantic HTML." },
    ...
    { q: "What is Core Web Vitals?", a: "Google's metrics for user experience — loading speed, interactivity, and visual stability. All Scalify sites are optimized for excellent Core Web Vitals scores." },
    ...
    { q: "What is mobile-first indexing?", a: "Google primarily uses the mobile version of your site for ranking. All Scalify websites are built mobile-first, so you're always ahead!" },
    ...
    { q: "What is HTTPS and does it affect SEO?", a: "HTTPS means your site is secure (SSL encrypted). Google confirms it's a ranking factor. All Scalify sites come with free SSL!" },
    ...
    { q: "Why is my business not on Google?", a: "Without a website and SEO, Google doesn't know your business exists! Scalify creates your online presence and optimizes it so Google finds and ranks you." },
    ...
    { q: "What is canonical URL?", a: "A tag telling Google which version of a page is the 'main' one. Prevents duplicate content issues. All Scalify sites have proper canonical tags." },
    ...
    { q: "Is SEO a one-time thing?", a: "SEO is ongoing. Google's algorithm evolves constantly. That's why monthly maintenance is essential — and it's all included in your ₹1,499/month plan!" },
  ...
  domain: [
    { q: "Do I need a domain name?", a: "You get a free subdomain (yourbusiness.scalifyapp.com). A custom domain (yourbusiness.com) is optional but recommended for professional branding. We help you connect it!" },
    { q: "How do I get a custom domain?", a: "Buy one from GoDaddy, Hostinger, or Namecheap (₹500-800/year). Then we'll connect it to your Scalify website for free!" },
    ...
    { q: "Can I transfer my domain to Scalify?", a: "You keep ownership of your domain! We just connect it to our hosting. You maintain full control at your registrar." },
    { q: "What happens to my domain if I cancel?", a: "Your domain is yours — you own it. If you cancel Scalify, just point it somewhere else. We never take ownership of your domain." },
    { q: "How long does domain connection take?", a: "DNS propagation takes 1-24 hours (usually 1-2 hours). Your site works immediately on the .scalifyapp.com subdomain while the domain connects." },
    ...
    { q: "Is the scalifyapp.com subdomain permanent?", a: "Your subdomain (yourbusiness.scalifyapp.com) is available as long as your subscription is active. It works alongside any custom domain you add." },
    ...
    { q: "Can I change my subdomain?", a: "Yes! If you want to change your .scalifyapp.com subdomain name, just ask in chat and we'll update it." },
    ...
    { q: "Do I need separate hosting?", a: "No! Hosting is fully included in your Scalify plan. No need to buy separate hosting from GoDaddy, Hostinger, etc." },
    { q: "Can I access FTP/cPanel?", a: "Scalify is a managed service — we handle all the technical stuff. You just tell us what changes you want. No need for cPanel!" },
    ...
    { q: "Do you support PHP or WordPress?", a: "Scalify uses its own modern web technology. No WordPress needed — our sites are faster, more secure, and easier to manage!" },
    { q: "Can I migrate from WordPress?", a: "Yes! We'll recreate your WordPress site on Scalify with proper redirects to keep your SEO. The new site will be faster and easier to manage." },
  ...
  support: [
    ...
    { q: "Is there a knowledge base?", a: "You're chatting with it! Our AI knows everything about websites, SEO, and Scalify. Ask any question!" },
  ...
  trust: [
    { q: "Is Scalify a real company?", a: "Yes! Scalify is a registered Indian company building affordable digital solutions for small businesses. We use Razorpay for payments and follow all business regulations." },
    { q: "How long have you been around?", a: "Scalify was built by a team of experienced web developers and SEO specialists who've been in the industry for years. We created Scalify to make professional websites accessible to every Indian business." },
    ...
    { q: "What if Scalify shuts down?", a: "Your data and content are always yours. We provide export options. But we're funded and growing — we're here for the long run!" },
    ...
    { q: "How are you different from Wix/WordPress?", a: "Wix = DIY (you build it yourself). WordPress = Complex (need a developer). Scalify = Done-for-you (AI builds it + SEO included). Easiest option!" },
    ...
    { q: "Do big businesses use Scalify?", a: "We specialize in small and medium businesses. If you're a startup, freelancer, or local business, Scalify is perfect for you!" },
    ...
    { q: "Why should I choose Scalify over hiring a developer?", a: "Speed: Website in minutes vs. weeks. Cost: ₹1,499/month vs. ₹25,000+ upfront. Support: 24/7 AI + human vs. chasing a freelancer. SEO: Included vs. ₹10K/month extra." },
    { q: "Can I see before and after results?", a: "We can share case studies showing how businesses improved their Google rankings and traffic after using Scalify!" },
    ...
    { q: "What makes Scalify unique?", a: "AI-powered website creation + real SEO optimization + ₹1,499/month all-inclusive. No one else offers this combination at this price in India!" },
    ...
    { q: "Is the 63% discount real?", a: "Yes! The regular price is ₹2,499/month. We're offering ₹1,499/month to early customers. This is a genuine limited-time discount." },
    { q: "How do I verify Scalify is legitimate?", a: "Check our app on the Play Store/App Store, our website, Razorpay payment gateway integration, and GST invoices. Everything is verifiable!" },
    { q: "Will my website have ads on it?", a: "Never! Your website is 100% yours with ZERO third-party ads or Scalify branding. It's a fully professional site." },
  ...
  comparisons: [
    { q: "Scalify vs Wix", a: "Wix: DIY builder, ₹250-700/month, NO SEO service, you build yourself. Scalify: Done-for-you, ₹1,499/month, FULL SEO included, AI builds it for you!" },
    { q: "Scalify vs WordPress", a: "WordPress: Need developer (₹15-50K), hosting extra (₹300-500/month), plugins break, no SEO. Scalify: Zero technical knowledge needed, everything managed, SEO included." },
    { q: "Scalify vs Squarespace", a: "Squarespace: International pricing (₹1,000-2,000/month), limited in India, no SEO service. Scalify: Made for Indian businesses, ₹1,499/month with full SEO!" },
    { q: "Scalify vs Shopify", a: "Shopify: E-commerce focused (₹2,000+/month), complex setup. Scalify: Service business focused, ₹1,499/month, simpler and more affordable for non-ecommerce!" },
    { q: "Scalify vs hiring a freelancer", a: "Freelancer: ₹15-50K upfront, weeks to deliver, unreliable for updates, no SEO. Scalify: ₹1,499/month, ready in minutes, unlimited updates, full SEO!" },
    { q: "Scalify vs digital agency", a: "Agency: ₹50K-2L for website + ₹10-25K/month for SEO. Scalify: ₹1,499/month for BOTH. Same quality, fraction of the cost!" },
    { q: "Scalify vs GoDaddy Website Builder", a: "GoDaddy: Basic builder + hosting ₹500/month, no SEO service. Scalify: Professional AI-built site + comprehensive SEO ₹1,499/month!" },
    { q: "Scalify vs Weebly", a: "Weebly: Outdated templates, limited features, no SEO. Scalify: Modern designs, full features, complete SEO — better value!" },
    { q: "Is Scalify better for Indian businesses?", a: "Absolutely! Made specifically for Indian businesses with UPI payment, Hindi content support, local SEO focus, and pricing in ₹. No international platform offers this!" },
    { q: "Can I switch from Wix to Scalify?", a: "Yes! We'll recreate your Wix site on Scalify, often with a better design and SEO. Many customers switch for the included SEO." },
    { q: "Can I switch from WordPress to Scalify?", a: "Absolutely! No more plugin updates, hosting hassles, or security worries. We migrate your content and set up proper redirects." },
    { q: "How is Scalify better than Canva websites?", a: "Canva: Basic one-page site, no SEO, no forms, limited features. Scalify: Multi-page website, full SEO, forms, WhatsApp, analytics!" },
    { q: "Scalify vs IndiaMart", a: "Different purposes! IndiaMart is a marketplace. Scalify gives you your OWN website that YOU own. Both can work together!" },
    { q: "Scalify vs Justdial", a: "Justdial is a directory listing. Scalify gives you a full professional website + SEO. Having both is ideal!" },
    { q: "Do I still need social media with Scalify?", a: "Yes! Social media + website + SEO = maximum online presence. We integrate everything together on your website." },
    { q: "Scalify vs Google Sites", a: "Google Sites: Free but extremely basic, no SEO tools, looks unprofessional. Scalify: Professional website + full SEO + support for ₹1,499." },
    { q: "Scalify vs Blogger", a: "Blogger: Blogging platform, limited design, not for business websites. Scalify: Full business website with blog capability + SEO!" },
    ...
    { q: "Scalify vs Zoho Sites", a: "Zoho: Website builder ₹300-600/month, no SEO service included. Scalify: Done-for-you website + full SEO at ₹1,499/month — more value!" },
    { q: "Can a website directory listing replace a website?", a: "Directory listings are helpful but limited. A website lets you detail services, show portfolio, rank for more keywords, and build credibility. Scalify gives you a full professional website!" },
    { q: "Scalify vs Webflow", a: "Webflow: Powerful but complex, needs designer (₹30K+), no SEO service. Scalify: Easy, done-for-you, SEO included for ₹1,499/month." },
    ...
    { q: "Scalify vs coding my own website", a: "Unless you're a developer, coding takes months and costs more. Scalify: Professional site in minutes, managed hosting, SEO, support — all for ₹1,499/month!" },
    { q: "Do I need both Scalify and social media?", a: "Think of it: Website = your digital shop (always open). Social media = your marketing (reach people). SEO = your signboard (people find you). Scalify handles website + SEO!" },
    { q: "Scalify vs Dukaan/Instamojo", a: "Those are e-commerce focused. Scalify is for service businesses and complete websites with SEO. If you sell services, Scalify is better!" },
    { q: "Can my developer build a better site?", a: "Maybe — for ₹30-50K upfront. But will they include monthly SEO, hosting, SSL, updates, and 24/7 support? Scalify does ALL of that for ₹1,499/month." },
    ...
    { q: "Scalify vs Jimdo", a: "Jimdo: European builder, limited India features, no SEO service. Scalify: Built for India, full SEO included, better value!" },
    { q: "What about free website builders?", a: "Free = ads on your site, their branding, ugly subdomains, no SEO, limited features, and looks unprofessional. ₹1,499/month for Scalify is worth every rupee!" },
    { q: "Scalify vs traditional web design company", a: "Traditional: ₹50K-2L upfront, weeks to deliver, charge for every change, SEO separate. Scalify: ₹1,499/month, ready in minutes, unlimited changes, SEO included!" },
    ...
    { q: "Scalify vs no website at all", a: "Without a website: Invisible to 93% of people who search online. Losing customers to competitors who have websites. Missing out on ₹lakhs in potential revenue!" },
    { q: "Is DIY better than done-for-you?", a: "DIY saves money but costs time. Most business owners don't have 20-40 hours to learn web design. Scalify gives professional results in minutes!" },
    { q: "Scalify vs local web designer", a: "Local designer: ₹10-30K upfront, slow updates, no SEO, disappears after delivery. Scalify: ₹1,499/month, ongoing support, continuous SEO, always available!" },
    ...
    { q: "Scalify vs Notion website", a: "Notion: Basic public pages, no real SEO, looks like notes. Scalify: Professional business website with full SEO optimization!" },
    ...
    { q: "Scalify vs Tilda", a: "Tilda: Beautiful but international pricing, no SEO service, limited India support. Scalify: India-focused, SEO included, ₹1,499/month!" },
    { q: "Which is best for a startup?", a: "Scalify! Startups need to launch fast and be found online quickly. ₹1,499/month gets you live with a professional site + SEO immediately." },
  ],

  // ─── GENERAL & MISC (50 questions) ───
  general: [
    { q: "How does Scalify work?", a: "Simple! 1) Subscribe (₹1,499/month) 2) Chat with our AI about your business 3) Your website goes live in minutes 4) We optimize SEO monthly. That's it!" },
    ...
    { q: "Do I need technical knowledge?", a: "Zero! If you can chat on WhatsApp, you can use Scalify. Just answer questions about your business in simple language." },
    ...
    { q: "When will my website be live?", a: "Within minutes of completing the chat! Your site goes live on yourname.scalifyapp.com immediately." },
    ...
    { q: "Is Scalify available across India?", a: "Yes! We serve businesses all over India — from metros to tier-2 and tier-3 cities. Online presence matters everywhere!" },
    { q: "Can I use Scalify outside India?", a: "Our primary market is India, but the platform works globally. International users can subscribe too!" },
    { q: "What makes a good website?", a: "Clear messaging, fast loading, mobile-friendly, easy navigation, strong calls-to-action, and SEO optimization. Scalify delivers all of these!" },
    ...
    { q: "What is a responsive website?", a: "A website that automatically adjusts to screen size — phone, tablet, laptop. All Scalify websites are fully responsive!" },
    { q: "Do I need a computer to manage my website?", a: "Nope! The Scalify app works on your phone. Manage your entire website from your pocket!" },
    { q: "What is a good website speed?", a: "Under 3 seconds loading time. Google recommends this for best user experience and SEO. Scalify sites are optimized for speed!" },
    ...
    { q: "How important is website design?", a: "First impressions matter! Visitors judge your business in 0.05 seconds. A professional Scalify website builds instant credibility." },
    ...
    { q: "What is UX design?", a: "User Experience design — how easy and pleasant your website is to use. Scalify sites are designed for intuitive navigation and clear information." },
    { q: "Do I need both a website and Instagram?", a: "Yes! Instagram for engaging followers, website for being found on Google. They complement each other. Scalify integrates both!" },
    ...
    { q: "What is website maintenance?", a: "Regular updates, security patches, backup checks, performance optimization, and content updates. All included in your ₹1,499/month plan!" },
    ...
    { q: "What's the first thing I should do?", a: "Subscribe to Scalify Pro (₹1,499/month) and start chatting with our AI to build your website. It takes just 5-10 minutes!" },
    { q: "I'm not sure if I need this...", a: "If you have a business and want more customers, you need an online presence. A website + SEO is the most effective way to get found. Try it for a month — ₹1,499 is less than one restaurant meal!" },
    { q: "What results can I expect?", a: "Month 1: Professional website live. Month 2-3: Start appearing in Google searches. Month 4-6: Significant organic traffic. The ROI on ₹1,499/month is incredible!" },
    { q: "Can I use Scalify for a personal website?", a: "Absolutely! Portfolio sites, resume websites, personal blogs — Scalify works for any type of website." },
    ...
    { q: "How do I get started?", a: "So easy! Go to the Plans tab → Subscribe for ₹1,499/month → Come back to AI Chat → Answer a few questions → Your website goes live! Takes 5 minutes ⚡" },
    { q: "What is branding?", a: "How your business is perceived — logo, colors, messaging. A Scalify website creates a consistent, professional brand identity online." },
    { q: "Should I invest in online presence?", a: "In 2026, it's not an option — it's a necessity. 97% of consumers search online. ₹1,499/month is the most affordable investment in your business's future." },
    ...
    { q: "I'm not tech-savvy, can I still use this?", a: "That's exactly who we built Scalify for! No technical knowledge needed. Just chat like you're talking to a friend, and we handle everything." },
    { q: "What if I already have a website?", a: "Great! We can rebuild it better with Scalify, add SEO, and bring in more traffic. Or keep your existing site and use us for SEO only — let's discuss!" },
